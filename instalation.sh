...
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/config/bspwm /home/carlos/.config
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/config/sxhkd /home/carlos/.config
sudo rm -r /home/carlos/.wallpapers/wallpaper.jpg
sudo rm -r /home/carlos/.config/polybar/shapes
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/config/.wallpapers /home/carlos
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/config/polybar/polybar-themes/simple/shapes /home/carlos/.config/polybar
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/config/polybar/polybar-themes/simple/shapes /home/carlos/.config/polybar
...
sudo dpkg -i /home/carlos/git/clone/zsh-with-plugins-and-more/lsd_0.21.0_amd64.deb
sudo dpkg -i /home/carlos/git/clone/zsh-with-plugins-and-more/bat_0.19.0_amd64.deb
sudo rm /home/carlos/git/clone/zsh-with-plugins-and-more/lsd_0.21.0_amd64.deb
sudo rm /home/carlos/git/clone/zsh-with-plugins-and-more/bat_0.19.0_amd64.deb
#Comandos Git clone
...
sudo mv /home/carlos/git/clone/zsh-with-plugins-and-more/Hack.zip /usr/share/fonts
...
sudo sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/{.p10k.zsh,.zshrc} /home/carlos
...
#Plugins ZSH
sudo cp -rf /home/carlos/git/clone/zsh-with-plugins-and-more/plugins-zsh /usr/share
...
if [ "$respuesta" == "si" ]
then
    /home/carlos/git/clone/zsh-with-plugins-and-more/Themes.sh
else
    p10k configure
fi
sudo apt update && sudo apt upgrade
